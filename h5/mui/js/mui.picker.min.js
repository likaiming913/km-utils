 ...
 **/
!function (e, t, i, n) {
    var a = 60, r = 180, s = 80, c = 20, l = e.rad2deg = function (e) {
    ...
    p.prototype.findElementItems = function () {
        ...
        e && (t.items = []), t.elementItems.forEach(function (i) {
            ...
            if (t.endAngle = t.itemAngle * n, i.angle = t.endAngle, i.style.webkitTransformOrigin = "center center -" + t.r + "px", i.style.webkitTransform = "translateZ(" + t.r + "px) rotateX(" + (-t.endAngle+11) + "deg)", e) {
                var a = {};
